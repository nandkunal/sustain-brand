                ...
                <table height="30px" width="900px" cellpadding="0" cellspacing="0" align="center" style="vertical-align:top">
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <tr>
                         <td><label for="name">Name of the Category*</label></td>
                         <td><input class="input-small" id="name" name="name" /></td>
                         </tr>
                     <tr>
                         <td><label for="name">Select Brand*</label></td>
                         <td><select name="brand" id="brand" size="1"><option value="0" selected="selected">Select</option><option value="1">Sustain Brand</option></select></td>
                         </tr>
                         <tr>
